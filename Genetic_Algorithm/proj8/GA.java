 ...
 protected void Mutate() 
    {
        ...
        for (int i = 0; i < numMutate; i++) 
        {
            ...
            int geneMut2 = rnum.nextInt(7) +1; //pos of second gene to mutate
            
            Chromosome newChromosome = GA_pop.remove(chromMut); //get chromosome
            
            //randomly swap 2 genes in a chromosome
 ...
 protected void InitPop()
    {
        ...
        for (int index = 0; index < GA_numChromesInit; index++)
        {
            ...
            //fills chromosome with letters a-h/ makes sure there are no duplcate genes.
